...
POSTGRES_PORT = os.getenv('POSTGRES_PORT', '5444')  # Docker mapped port
...
async def create_tables():
    ...
    try:
        async with engine.begin() as conn:
            ...
            # Удаляем существующие таблицы если есть (чтобы можно было пересоздать ENUMs)
            ...
            print("✅ Создан notificationstatus")
            ...
            print("✅ Создан notificationtype")

            print("✅ Все ENUM типы пересозданы с uppercase значениями")
